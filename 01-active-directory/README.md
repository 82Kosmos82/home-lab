...
| `Drive-Map-Policie.png` | політика для маппінгу файлової шари для юзерів маркетингу |
| `Drive-Map-test1.png` | тестування чи спрацювали політики мапінгу |
| `Drive-Map-test1.png` |тестування чи правильно підтягнулись політики мапінгу дисків з іншими обмеженнями по правам шар |
